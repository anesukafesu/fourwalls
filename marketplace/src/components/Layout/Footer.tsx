    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Kigali's most delightful housing marketplace. Connect with expert agents and discover your dream property.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-heading font-bold mb-4 text-gray-300">Quick Links</h3>
          ...
          {/* Resources */}
          <div>
            <h3 className="font-heading font-bold mb-4 text-gray-300">Resources</h3>
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <button 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2024 fourwalls Rwanda. All rights reserved. | Data scraping prohibited.</p>
        </div>
      </div>
    </footer>
  );
